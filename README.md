# JS Bootcamp Repository

## I talk about the following things in this repository:
* [ECMAScript and the JavaScript language](https://github.com/IrisvanOllefen/js-bootcamp/blob/master/1-about-ecmascript-and-javascript.md)
* [Values, types and keywords](https://github.com/IrisvanOllefen/js-bootcamp/blob/master/2-values-types-more.md)
