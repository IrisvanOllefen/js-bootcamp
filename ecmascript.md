...
[Eloquent JavaScript](https://eloquentjavascript.net/00_intro.html).  return   
[ECMAScript Guide](https://flaviocopes.com/ecmascript/_).  return   
[MDN JavaScript Guide](https://developer.mozilla.org/en-US/docs/MDN/Contribute/Guidelines/Code_guidelines/JavaScript#General_JavaScript_guidelines).  return   
[ECMAScript explained by Techopedia](https://www.techopedia.com/definition/14291/ecmascript).  return   
[freeCodeCamp about ECMAScript](https://www.freecodecamp.org/news/whats-the-difference-between-javascript-and-ecmascript-cba48c73a2b5/).  return   
